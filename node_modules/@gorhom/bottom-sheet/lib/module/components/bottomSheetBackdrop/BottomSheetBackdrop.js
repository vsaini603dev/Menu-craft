...
const BottomSheetBackdropComponent = ({
  ...
  const containerStyle = useMemo(() => [StyleSheet.absoluteFill, styles.backdrop, style, containerAnimatedStyle], [style, containerAnimatedStyle]);
  //#endregion
...
export const BottomSheetBackdrop = /*#__PURE__*/memo(BottomSheetBackdropComponent);
