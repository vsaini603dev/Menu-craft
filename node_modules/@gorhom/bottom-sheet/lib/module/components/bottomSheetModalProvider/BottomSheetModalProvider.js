...
const BottomSheetModalProviderWrapper = ({
  ...
  const handleMountSheet = useCallback((key, ref, stackBehavior) => {
    ...
    const currentMountedSheetWillUnmount = currentMountedSheetStatus !== undefined && currentMountedSheetStatus === MODAL_STATUS.DISMISSING;
  ...
  const handleUnmountSheet = useCallback(key => {
    ...
    const minimizedSheetWillUnmount = minimizedSheetStatus !== undefined && minimizedSheetStatus === MODAL_STATUS.DISMISSING;
